...
{
    public static void DrawBoxOverlap2D(Vector2 origin, Vector2 size, float angle, Color color, float duration = 0)
    {
        Quaternion angle_z = Quaternion.Euler(0f, 0f, angle);
        DrawBox(origin, size / 2f, angle_z, color, duration);
    }
    ...
    */
    ...
    private static void DrawBox(Vector3 origin, Vector3 halfExtents, Quaternion orientation, Color color, float duration)
    {
